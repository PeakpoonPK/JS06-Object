...
//Mini-lab
//สร้าง objection ของตัวเอง
//ระบุคุณสมบัติของตัวเองสัก 2-3 ข้อ ระบุความสามารถของตัวเอง 4 อย่าง (Cover ทุก syntax)
//key: namedFunction
// key: anonymous FN
// key: arrowFN
// key: shorthand
...
//     },
//     eatAllNight: (manu) => console.log("I'm eating all the time"),
//     focus(task) {
...
// myself.sport('basketball');
// myself.sleepAllDay();
// myself.eatAllNight('Tax');
// myself.focus('javascript lab');
